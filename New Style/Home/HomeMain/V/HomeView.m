...
@property (nonatomic, assign) NSArray *nameArray;   //名字数组
@property (nonatomic, strong) UIButton *alreadySelectButton;   //记录上一次选择的按钮
@property (nonatomic, retain) NSMutableArray *buttonArray;   //将循环创建的button存储起来
...
@property (nonatomic, strong) UITapGestureRecognizer *singleTap;    //图片点击事件
...
- (void)pressSelect:(UIButton *)button {
    [self.imageScrollView setContentOffset:CGPointMake(SIZE_WIDTH * button.tag, 0) animated:YES];
